...
:root {
  ...
  --color-primary-bg:    rgba(59, 130, 246, 0.10);  /* 主色极淡背景 */
}

/* 暗色模式覆盖（由 JS 动态注入） */
.dark {
  --color-primary-light: rgba(59, 130, 246, 0.15);
  --color-primary-bg:    rgba(59, 130, 246, 0.10);
...
<div class="flex flex-col gap-4">   <!-- 或 space-y-4 -->
...
<div class="space-y-4">
  ...
  <div class="flex items-start gap-4">
    ...
    <div class="flex-1 min-w-0">
      <p class="text-sm text-gray-800 dark:text-white truncate">主要文字</p>
      <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">次要文字</p>
    </div>
  </div>
</div>
```
...
<div class="flex items-center justify-between">
  <div>
    ...
    <p class="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1">数值</p>
    <!-- 趋势行 -->
  ...
  <div class="w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900/30
              flex items-center justify-center flex-shrink-0">
...
<div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm">
  ...
  <div class="flex items-center justify-between px-6 h-14
    ...
    <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">标题</h3>
    <button>...</button>
  </div>
  <!-- 内容区 -->
...
<div class="flex items-center gap-3 px-4 py-3
  ...
  <div class="flex-1 min-w-0">
    <p class="text-sm text-gray-800 dark:text-gray-200 truncate">主要文字</p>
    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5 truncate">次要说明</p>
  </div>

  <!-- 右侧附加（时间戳、角标、操作）-->
  <span class="text-xs text-gray-400 dark:text-gray-500 flex-shrink-0">2分钟前</span>
</div>
```
...
<label class="flex items-center justify-between cursor-pointer">
  ...
  <!-- Toggle 开关 -->
  <div class="relative w-11 h-6 rounded-full transition-colors cursor-pointer
...
<div>
  ...
  <div class="grid grid-cols-3 gap-3">
    <button class="flex flex-col items-center gap-2 p-3 rounded-lg border-2
...
<div>
  ...
  <div class="flex flex-wrap gap-3">
    <button class="w-8 h-8 rounded-full transition-transform hover:scale-110"></button>
  </div>
</div>
```
...
```html
<!-- 一级无子项 -->
<button class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm
...
<ul class="ml-4 mt-1 space-y-1">
  <li>
    <button class="w-[calc(100%-0.5rem)] flex items-center gap-2 px-3 py-2
...
```html
<button class="flex items-center justify-center px-3 py-2.5 rounded-lg
...
```html
<!-- 无子项 -->
<button class="h-full flex items-center gap-1.5 px-3 text-sm font-medium
...
<div class="flex items-center gap-1 flex-1 overflow-x-auto overflow-y-hidden
  ...
  <!-- 单个 Tab -->
  <div class="group flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm
    ...
    <!-- 关闭按钮（hover 时显示）-->
    <button class="w-4 h-4 rounded-full flex items-center justify-center
...
```html
<!-- 抽屉容器：固定宽高，flex 列方向 -->
<div class="fixed right-0 top-0 h-full w-80 flex flex-col
            bg-white dark:bg-gray-800 shadow-2xl z-[201]">

  <!-- 头部：固定高度 h-16 -->
  <div class="flex items-center justify-between h-16 px-6
              border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
    <h2 class="text-base font-semibold text-gray-900 dark:text-gray-100">标题</h2>
  ...
  <div class="p-4 border-t border-gray-200 dark:border-gray-700 flex-shrink-0">
    <button class="w-full btn-primary py-2.5 rounded-lg text-sm font-medium">
      确认
    </button>
  </div>
</div>
...
<div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
  <div class="flex items-center justify-between">
    ...
    <!-- 图标区域 -->
    <div class="w-12 h-12 bg-blue-100 dark:bg-blue-900/30 rounded-full
                flex items-center justify-center">
      <i class="fas fa-icon text-blue-600 dark:text-blue-400"></i>
    </div>
  </div>
...
```html
<button class="btn-primary px-4 py-2.5 rounded-lg font-medium
...
```html
<button class="px-4 py-2.5 rounded-lg font-medium text-sm
...
<div class="relative">
  <!-- 触发器 -->
  <button class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm
                 text-gray-700 dark:text-gray-300
                 hover:bg-gray-100 dark:hover:bg-gray-700/50
                 transition-colors">
    <span>选项文字</span>
  ...
  >
    <div class="absolute right-0 mt-2 w-48 z-50
                bg-white dark:bg-gray-800
                rounded-lg shadow-lg
                border border-gray-200 dark:border-gray-700
                py-1">
      <!-- 选项 -->
      <button class="w-full flex items-center gap-2 px-4 py-2 text-sm
                     text-gray-600 dark:text-gray-400
                     hover:bg-gray-100 dark:hover:bg-gray-700/50
                     transition-colors">
...
```html
<select class="w-full px-3 py-2 rounded-lg text-sm
               border border-gray-200 dark:border-gray-600
               bg-white dark:bg-gray-700
               text-gray-900 dark:text-gray-100
               focus:outline-none focus:ring-2 focus:ring-primary
